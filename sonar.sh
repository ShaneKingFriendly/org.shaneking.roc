...
if [ ${SK_EXP__SONAR__TOKEN} ]; then
  ...
  sk_roc_modules=("org.shaneking.roc.cache" "org.shaneking.roc.jackson" "org.shaneking.roc.persistence" "org.shaneking.roc.persistence.simple" "org.shaneking.roc.rr" "org.shaneking.roc.test" "org.shaneking.roc.zero")
