...
public class SimpleRrAsyncLogEntity extends RrAsyncLogExample implements NumberedUniIdx, SqlliteSqlEntities {
  @Override
  public Class<? extends SimpleRrAsyncLogEntity> entityClass() {
