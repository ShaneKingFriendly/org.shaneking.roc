...
public class SimpleRrAuditLogEntity extends RrAuditLogExample implements NumberedIdx, SqlliteSqlEntities {
  @Override
  public Class<? extends SimpleRrAuditLogEntity> entityClass() {
