...
public class SimpleChannelAccessUrlApiEntity extends ChannelAccessUrlApiExample implements ChannelizedNumberedUniIdx, SqlliteSqlEntities {
  @Override
  public Class<? extends SimpleChannelAccessUrlApiEntity> entityClass() {
