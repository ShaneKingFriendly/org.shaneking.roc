...
public class HelloChannelAccessSignatureApiEntity extends ChannelAccessSignatureApiExample implements ChannelizedNumberedUniIdx, SqlliteSqlEntities {
  @Override
  public Class<? extends HelloChannelAccessSignatureApiEntity> entityClass() {
