...
class HelloCacheableEntityTest extends SKUnit {
  ...
  @Test
  void testToString() {
    assertEquals("HelloCacheableEntity(super=AbstractCacheableEntity(super=AbstractDialectSqlEntity(id=null, dd=N, no=null, invalid=null, lastModifyDateTime=null, lastModifyUserId=null, version=null), lastModifyUser=null))", new HelloCacheableEntity().toString());
  }
}
