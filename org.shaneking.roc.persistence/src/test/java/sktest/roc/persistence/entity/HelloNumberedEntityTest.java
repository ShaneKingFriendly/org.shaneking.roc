...
class HelloNumberedEntityTest extends SKUnit {
  ...
  void testToString() {
    assertAll(
      () -> Assertions.assertEquals("HelloNumberedEntity(super=CacheableEntity(super=AbstractIdNoAdtVerSqlEntity(id=null, no=null, invalid=null, lastModifyDateTime=null, lastModifyUserId=null, version=null), lastModifyUser=null))", new HelloNumberedEntity().toString()),
