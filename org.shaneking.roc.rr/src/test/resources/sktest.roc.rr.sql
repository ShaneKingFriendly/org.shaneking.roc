...
(
  ...
  `allow_url_regex` varchar
(
  255
) default '',
  `allow_signature_regex` varchar
(
  255
) default '',
  `deny_url_regex` varchar
(
  255
) default '',
  `deny_signature_regex` varchar
(
  255
) default '',
  primary key
...
select '1612262610215_LoHqeZBGrVYm3MlYmpH',
       'tstTenantNo',
       '',
...
select '1612263653223_oGFvE5Hyndf0njoFhyK',
       ...
       'SKC1',
       'SELF';
insert into t_simple_channel_access_regex_api_entity (id, no, lm_dsz, lm_uid, channel_id, allow_url_regex,
                                                      allow_signature_regex, deny_url_regex, deny_signature_regex)
select '1612263668482_jaHu6tmguyKo2xWgHPj',
       '',
       '',
       '1612262610216_koFVLCNZrhezbgULWqW',
       '1612263653223_oGFvE5Hyndf0njoFhyK',
       '',
       '^[\s\S]*(add|rmvById|modByIdVer|lst)\([\s\S]*$',
       '',
       '';


select *
from t_simple_channel_access_regex_api_entity;
select *
from t_simple_channel_access_signature_api_entity;
select *
from t_simple_channel_access_tenant_regex_api_entity;
select *
from t_simple_channel_access_tenant_signature_api_entity;
select *
from t_simple_channel_access_tenant_url_api_entity;
select *
from t_simple_channel_access_url_api_entity;
select *
from t_simple_channel_entity;
select *
from t_simple_rr_async_log_entity;
select *
from t_simple_rr_audit_log_entity;
select *
from t_simple_tenant_entity;
select *
from t_simple_user_entity;
