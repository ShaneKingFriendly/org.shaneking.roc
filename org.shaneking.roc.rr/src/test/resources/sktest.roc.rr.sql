...
insert into t_hello_tenant_entity (id, no, last_modify_date_time, last_modify_user_id, name, description)
select '1612262610215_LoHqeZBGrVYm3MlYmpH','tstTenantNo','','1612262610216_koFVLCNZrhezbgULWqW','tstTenantName','tstTenantDesc';
insert into t_hello_user_entity (id, no, last_modify_date_time, last_modify_user_id, tenant_id, name, haha, mobile, email)
