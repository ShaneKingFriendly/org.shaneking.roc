...
-- insert into t_hello_user_entity (version, id, invalid, last_modify_date_time, last_modify_user_id, tenant_id, haha, mobile, name, email)
-- select 0, '1612262610216_koFVLCNZrhezbgULWqW', 'N', '', '', 'tsttenant', '[C3]494c6f7665596f75', '18888888888', 'tstuser', 'email@email.com'
